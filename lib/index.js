...
module.exports = function mongoQueue(opts) {
  ...
  var queue = queueFn({
    ...
    continueProcessingOnError: opts.hasOwnProperty('continueProcessingOnError')
      ? opts.continueProcessingOnError
      : true,
  ...
  if (opts.processCron && isCronEnabled === true) {
    console.log(opts.collectionName + '-process');
  ...
  if (opts.cleanupCron && isCronEnabled === true) {
    console.log(opts.collectionName + '-cleanup');
  ...
  if (opts.statusesMonitorCron && isCronEnabled === true) {
    console.log(opts.collectionName + '-statuses-check');
